...
- (void)createViews {
    ...
    view3.grx_identifier = @"view3";
    GRXRelativeLayoutParams *params3 = [[GRXRelativeLayoutParams alloc] initWithSize:CGSizeMake(50, 50)];
    [params3 setParentRule:GRXRelativeLayoutParentRuleCenterHorizontal];
